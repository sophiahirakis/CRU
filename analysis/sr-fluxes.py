...
react_data_files = [
                     [['RyRO1_H1_SR_efflux.World.dat','RyRO1_L_SR_efflux.World.dat','RyRO2_H1_SR_efflux.World.dat','RyRO2_L_SR_efflux.World.dat','RyRO3_L_SR_efflux.World.dat'], 'RyR Efflux Reactions', 'EffluxRyR', -1 ],
                     [['RyRO1_H1_SR_influx.World.dat','RyRO1_L_SR_influx.World.dat','RyRO2_H1_SR_influx.World.dat','RyRO2_L_SR_influx.World.dat','RyRO3_L_SR_influx.World.dat'], 'RyR Influx Reactions', 'InfluxRyR', -1 ],
                     [['LTCC_Ca12_efflux.World.dat','LTCC_N6_efflux.World.dat',], 'LTCC Efflux Reactions', 'EffluxLTCC', -1 ],
                     [['LTCC_Ca12_influx.World.dat','LTCC_N6_influx.World.dat',], 'LTCC Influx Reactions', 'InfluxLTCC', -1 ],
    ...
    for react_data_file_list in react_data_files:
        ...
        for seed_dir in all_seed_dirs:
            ...
            for dat_file in react_data_file_list[0]:
                ...
                d = d[:30000, :]  # Read only up to the 20000th index
